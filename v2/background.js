    ...
    const html = items.map((item, index) => {
        ...
        <div class="icons">
            ...
            <label class="switch" for="extension_checkbox_${item.name.toLowerCase().split(' ').join('_')}">
                <input type="checkbox" class="extension_checkbox_${item.name.toLowerCase().split(' ').join('_')} extensiontoggle" id="extension_checkbox_${item.name.toLowerCase().split(' ').join('_')}">
...
const init = () => {
    ...
    document.getElementById('toggleCollapsedMenuDisplay').addEventListener('click', toggleCollapsedMenuDisplay);
    populateMenu()
